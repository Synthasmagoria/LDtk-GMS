...
/// __ldtk_iutil_asset_get_index_type(name, type)->real
...
/// __ldtk_iutil_string_rpos(substr,str)->real
//
...
///__ldtk_iutil_int_get_bit(int, ind)->real
return (argument0 >> argument1) & 1;

#define __ldtk_iutil_file_text_open_read_all_strings
/// __ldtk_iutil_file_text_open_read_all_strings(path)->string
var path = argument0;
...
/// __ldtk_iutil_ds_get(l_val, ...)->real
...
/// __ldtk_iutil_color_to_int(color, alpha)->real
